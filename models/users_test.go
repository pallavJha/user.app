...
var (
	userDBTypes = map[string]string{`ID`: `uuid`, `Username`: `string`, `Email`: `string`, `Password`: `string`, `IsSuperuser`: `bool`, `LastLogin`: `timestamptz`, `CreatedAt`: `timestamptz`, `UpdatedAt`: `timestamptz`, `DeletedAt`: `timestamptz`}
	_           = bytes.MinRead
)
