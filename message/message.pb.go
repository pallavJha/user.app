...
var fileDescriptor_ebceca9e8703e37f = []byte{
	...
	,
}
...
type UserAppClient interface {
	...
	DeleteUserRequest(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Empty, error)
}
...
func (c *userAppClient) DeleteUserRequest(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/message.UserApp/DeleteUserRequest", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserAppServer interface {
	...
	DeleteUserRequest(context.Context, *Empty) (*Empty, error)
}
...
func (*UnimplementedUserAppServer) DeleteUserRequest(ctx context.Context, req *Empty) (*Empty, error) {
...
func _UserApp_DeleteUserRequest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserAppServer).DeleteUserRequest(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/message.UserApp/DeleteUserRequest",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserAppServer).DeleteUserRequest(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _UserApp_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _UserApp_DeleteUserRequest_Handler,
		},
	},
